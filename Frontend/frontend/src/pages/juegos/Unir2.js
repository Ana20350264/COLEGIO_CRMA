...
import img1 from '../../img/tema2/1lunch.jpg';
import img2 from '../../img/tema2/2nap.jpg';
import img3 from '../../img/tema2/3takebus.jpg';
import img4 from '../../img/tema2/4wakeup.jpg';
import img5 from '../../img/tema2/5washinghands.jpg';
...
function HomePage() {
  ...
  return (
    <HomeContainer>
      ...
      <NavigationButtons>
        <button><Link to="/oracion2">Anterior</Link></button>
        <button><Link to="/crucigrama2">Siguiente</Link></button>
      </NavigationButtons>
