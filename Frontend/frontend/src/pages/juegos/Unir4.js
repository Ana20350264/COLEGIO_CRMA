...
import img1 from '../../img/tema4/1cry.jpg';
import img2 from '../../img/tema4/2kiss.jpg';
import img3 from '../../img/tema4/3look.jpg';
import img4 from '../../img/tema4/6reach.jpg';
import img5 from '../../img/tema4/5meet.jpg';
...
function HomePage() {
  ...
  return (
    <HomeContainer>
      ...
      <NavigationButtons>
        <button><Link to="/oracion4">Anterior</Link></button>
        <button><Link to="/crucigrama4">Siguiente</Link></button>
      </NavigationButtons>
