...
import img1 from '../../img/tema5/1computer.jpg';
import img2 from '../../img/tema5/2fax.jpg';
import img3 from '../../img/tema5/3news.jpg';
import img4 from '../../img/tema5/4script.jpg';
import img5 from '../../img/tema5/5printer.jpg';
...
function HomePage() {
  ...
  return (
    <HomeContainer>
      ...
      <NavigationButtons>
        <button><Link to="/oracion5">Anterior</Link></button>
        <button><Link to="/crucigrama5">Siguiente</Link></button>
      </NavigationButtons>
