...
import img1 from '../../img/tema1/1exhibition.jpg';
import img2 from '../../img/tema1/2concerts.jpg';
import img3 from '../../img/tema1/3filmfestival.jpg';
import img4 from '../../img/tema1/4dance.jpg';
import img5 from '../../img/tema1/5fashionshow.jpg';
...
function HomePage() {
  ...
  const items = [
    { id: 1, text: 'ART EXHIBITIONS' },
    { id: 2, text: 'MUSIC CONCERTS' },
    { id: 3, text: 'FILM FESTIVALS' },
    { id: 4, text: 'PRACTICE DANCE' },
    { id: 5, text: 'FASHION SHOWS' },
  ];
  ...
  return (
    <HomeContainer>
      ...
      <NavigationButtons>
        <button><Link to="/oracion1">Anterior</Link></button>
        <button><Link to="/crucigrama1">Siguiente</Link></button>
      </NavigationButtons>
