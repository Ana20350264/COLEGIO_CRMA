...
import img1 from '../../img/tema6/comedy.jpg';
import img2 from '../../img/tema6/horrorfilm.jpg';
import img3 from '../../img/tema6/lovestory.jpg';
import img4 from '../../img/tema6/romanticcomedy.jpg';
import img5 from '../../img/tema6/science.jpg';
...
function HomePage() {
  ...
  const items = [
    { id: 1, text: 'COMEDY' },
    { id: 2, text: 'HORROR FILMS' },
    { id: 3, text: 'LOVE STORY' },
    { id: 4, text: 'ROMANTIC COMEDY' },
    { id: 5, text: 'SCIENCE FICTION' },
  ];
  ...
  return (
    <HomeContainer>
      ...
      <NavigationButtons>
        <button><Link to="/oracion6">Anterior</Link></button>
        <button><Link to="/crucigrama6">Siguiente</Link></button>
      </NavigationButtons>
